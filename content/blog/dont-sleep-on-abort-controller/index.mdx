...
- The `signal` property, which is an instance of `AbortSignal`. This is a pluggable part you can provide to any API to react to an abort even, and implement it accordingly. For example, providing it to a `fetch()` request will abort the request;
