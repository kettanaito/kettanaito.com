...
The [Proxy](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Proxy) API is a powerful feature in JavaScript. You can think of it as a spy on objects but that description doesn't do it justice. I've noticed I've been using it a lot lately, specifically when it comes to debugging rather tricky issues. Today, I will show you how.
