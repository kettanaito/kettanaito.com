...
But what if we wanted to associate, say, _text formatting_ with certain words or letters within the poem? Formatting is an abstract concept that we now have to imeplement. As with anything in software engineering, there are multiple ways to go about this.
