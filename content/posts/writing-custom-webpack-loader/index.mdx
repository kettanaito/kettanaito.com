---
id: 0b6f661c-9777-46e9-b303-2496844e1762
date: 2021-06-06
category: Engineering
title: Writing a custom webpack loader
description: Excel your webpack knowledge by learning how to write a custom webpack loader that turns an MP3 file import into an interactive audio player.
keywords:
  - webpack
  - custom
  - loader
...
We will be using the [`<audio>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/audio) HTML element to play an imported audio file. For that, we need to know the path of the imported MP3 file, emit it in the webpack's build directory, and provide as the `src` attrbiute of the `<audio>` element.
...
<GitHubRepo owner="redd-developer" repo="webpack-custom-loader" />
