...
Originally designed by [Tatu Ylönen](https://twitter.com/tjssh) in Helsinki University of Technology, SSH has got widely adopted and gradually became a standard in software engineering. Most of the websites you visit today use SSH for various purposes, like sendind and acceptind traffic, or transfering files.
